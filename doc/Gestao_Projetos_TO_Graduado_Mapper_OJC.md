...
| :--- | :--- | :--- | :---: |
| RNF01 | Usabilidade | Interface consistente com design industrial moderno (Glassmorphism). | **Essencial** |
| RNF02 | Performance | Tempo de resposta para mapeamento inferior a 2 segundos. | **Essencial** |
| RNF03 | Segurança | Persistência de senhas utilizando hash SHA-256 (não plaintext). | **Essencial** |
| RNF04 | Portabilidade | Disponibilidade via executável único sem necessidade de instalar Python. | **Essencial** |
| RNF05 | Robustez | Tratamento de erros para caminhos de rede inacessíveis. | **Importante** |
